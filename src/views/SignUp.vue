<template>
  <div class="SignUp">
    <div class="font-sans-thai bg-gray-2 h-full mx-auto 2xl:pt-16 xl:pt-10 lg:pt-11 md:pt-16 pt-16">
      <!-- toast -->
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                />
                                <span
                                  class="label-text 2xl:pr-0 md:pl-2 md:pr-4"
                                  >แรงงานต่างด้าว</span
                                >
                              </label>
                            </div>
                        ...
                        <div v-if="signType == 'employer'" class="w-full mb-5">
                          <label
                            ...
                            class="
                              ...
                              px-1
                            "
                            >เบอร์โทรศัพท์ที่สามารถติดต่อได้ของบริษัท</label
                          >
                          <div class="flex">
                            <div
                              class="
...
<script>
import TermAndCondi from "@/components/TermAndCondi.vue";
    ...
    nextStep() {
      if (this.signType == "worker") {
        ...
        if (this.step < this.allStep) {
          if (this.step == 1) {
            this.checkPageOne();
            if (!this.emailInput && !this.passwordInput && !this.secPassInput) {
              this.step++;
            }
          } else if (this.step == 2) {
            this.checkPageTwoWorker();
            if (
